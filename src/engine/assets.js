...
export const TRADE_BG = require('../../assets/flowertradeshop.png');   // market exterior (scales)
export const TRADING_BG = require('../../assets/tradingscreen.png');    // the 6-slot trade page
